...
Tracing is disabled unless ``VLLM_ASCEND_PD_TRACE_PATH`` is set.
"""
...
_TRACE_PATH_ENV = "VLLM_ASCEND_PD_TRACE_PATH"
_TRACE_ROLE_ENV = "VLLM_ASCEND_PD_TRACE_ROLE"
...
def trace_event(event: str,
    ...
    try:
        ...
        # Tracing must never affect the serving path.
        return
